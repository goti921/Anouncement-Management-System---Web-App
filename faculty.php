    ...
    <body>
        ...
        <section id="main">
            ...
            <section id="container">
                <form action="process/faculty.php" method="POST">
                    <fieldset>
                        <legend>Faculty Login</legend>
                        <table>
                        <tr><td width="150px" style="padding:15px;"><label for="uname">Employee ID</label></td><td><input type="text" name="username" id="uname" required></td></tr>
